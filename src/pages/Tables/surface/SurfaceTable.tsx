...
function SurfaceTable() {
  ...
  return (
    <>
      ...
      />
      <PageBreadcrumb pageTitle="Bề mặt" />
      <div className="space-y-6">
        <TableComponentCard
          title="Bảng bề mặt"
          addButtonLink={"add-surface"}
          addButtonText={"Tạo bề mặt"}
          useModal={true}
          ...
          modalContent={
            <div>
              <h1 className="text-2xl font-bold mb-2 text-black">Tạo bề mặt</h1>
              <div className="grid grid-cols-2 gap-4 space-y-2">
                <div className="col-span-2">
                  <ProductLabel>Mã bề mặt</ProductLabel>
                  <Input
                ...
                <div className="col-span-2">
                  ...
                  <TextArea
                    ...
                    value={surfaceStore.surfaceForm.description || ""}
                    onChange={(value) =>
                      surfaceStore.updateSurfaceForm("description", value)
                    }
                  />
                </div>
              </div>
