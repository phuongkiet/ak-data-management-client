...
const ProductTextArea: React.FC<TextareaProps> = ({
  ...
  let textareaClasses = `w-full rounded-lg border px-4 py-2.5 shadow-theme-xs focus:outline-hidden ${className} `;
...
export default observer(ProductTextArea);
